...
enum Id { PROGRAM, 
	TOPDEC, VARDEC, SCALAR_TYPE, ARR_TYPE, 
	FUNC, FUNCBODY, FORMAL, EXTERN,
	PLUS,
	COMPOUND_STMNT, STMNT, 
	SIMPLE_COMPOUND_STMNT, EMPTY_STMNT, IF, WHILE, RETURN, 
	EFFECT, ASSIGN, BINARY,	UNARY,
	ARRAY, FCALL,
	IDENT, INTEGER_LITERAL, EXPR,
	VOID,CHAR, INT, DOUBLE}
//Shin : I put EXPR, TOPDEC, FORMAL, FUNCBODY right here.
//I didn't use a lot of ID here like COMPOUND_STMNT, SIMPLE_COMPOUND_STMNT 
//Because I can't understand How I can use it.
...
public class Node {
	...
	// Shin : I added this to make easier to manage list.
...
/*
 * //I added this to make if easily. class IFNode extends Node {
 * 
 * public IFNode(Node stmt, Node else_stmt) { super(Id.IF); op = _op; add(stmt);
 * add(else_stmt); setPosition(Position.combine(left.getPosition(),
 * right.getPosition())); }
 * 
 * public void print(String prefix) { print(prefix, op+""); } }
 */
